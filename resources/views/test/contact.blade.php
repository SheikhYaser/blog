                    ...
                    <div class="col-md-8 col-lg-8 pb-4">
                        ...
                        <form method="post" action="{{ route('post.store') }}">
                            ...
                            <div class="form-group mb-5">
                                ...
                                <textarea name="text" class="form-control" id="message" cols="30" rows="5"></textarea>
                            </div>
                            <input type="hidden" name="ko`rilganlar_soni" value="1">

                            <button type="submit" name="ok" class="btn btn-primary-hover-outline">Yuborish</button>
                        </form>
